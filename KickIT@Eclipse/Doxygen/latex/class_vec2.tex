...
\hyperlink{class_vec2}{Vec2} constructor \index{Vec2@{Vec2}!Vec2@{Vec2}}
\index{Vec2@{Vec2}!Vec2@{Vec2}}
...
\hyperlink{class_vec2}{Vec2} constructor
...
\hline
\end{DoxyParams}
scalarproduct = laenge1 $\ast$ laenge2 $\ast$ cos (angle between)
...
\item 
Kick\+I\+T@\+Eclipse/5\+\_\+\+Data\+Type/\hyperlink{_vec2_8hpp}{Vec2.\+hpp}\end{DoxyCompactItemize}
